...
class ResumenReuoPage extends StatefulWidget {
  final List<Map<String, dynamic>>? data;
  const ResumenReuoPage(
      {super.key,
      this.data,
      });

  @override
  State<ResumenReuoPage> createState() => _ResumenReusoPageState();
}

class _ResumenReusoPageState extends State<ResumenReuoPage> {
  late Size _size;
  double totalKilos = 0;
  double valorPagar = 0;
  double valor = 0;
  final _cubit = ReusoCubit();
          ...
          children: [
            ...
            BtnWidget(
                    action: () async {
                      ...
                      final r = await _cubit.registrarReuso(mapData!);
                      if (r) {
