...
class ResumenVentaPage extends StatefulWidget {
  ...
  final MayoristaModel recolectorModel;
  const ResumenVentaPage(
      {super.key,
      this.data,
          ...
          children: [
              ...
              child: Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                          "Recolector: ${widget.recolectorModel.nombre}"),
            ...
            BtnWidget(
                    action: () async {
                      ...
                      final r = await _ventaC.realizarCompra(mapData!);
                      if (r) {
