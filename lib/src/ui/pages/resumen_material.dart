...
import 'package:acopios/src/ui/blocs/add_material/add_material_cubit.dart';
...
class ResumenMaterial extends StatefulWidget {
  final List<Map<String, dynamic>>? data;

  const ResumenMaterial({super.key, required this.data});

  @override
  State<ResumenMaterial> createState() => _ResumenMaterialState();
}

class _ResumenMaterialState extends State<ResumenMaterial> {
  late Size _size;
  double totalKilos = 0;
  double valorPagar = 0;
  double valor = 0;
  final _cubit = AddMaterialCubit();
          ...
          children: [
            ...
            BtnWidget(
                action: () async {
                  ...
                  final r = await _cubit.addMaterial(mapData!);
                  if (r) {
