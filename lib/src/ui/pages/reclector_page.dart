...
import '../../core/custom_input_formatter.dart';
...
class RecolectorPagState extends StatefulWidget {
  ...
  const RecolectorPagState(
      {super.key, this.isEdit = false, this.recolectorModel});
...
class _RecolectorPagStateState extends State<RecolectorPagState> {
  ...
  _init(enabled) {
    ...
    if (widget.isEdit) {
      _recolectorCubit.addDataEdi(widget.recolectorModel!);
    }
  }
                    ...
                    child: BtnWidget(
                        ...
                        action: () async {
                          final r = await _recolectorCubit.crearRecolector(
                              edit: widget.isEdit,
                              idR: widget.isEdit
                                  ? widget.recolectorModel!.idRecolector
                                  : null);
                          if (r) {
                        ...
                        txt: widget.isEdit ? "Editar" : "Crear"),
                  );
                },
              ),
            ],
