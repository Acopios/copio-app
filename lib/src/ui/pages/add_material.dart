...
import 'package:acopios/src/ui/pages/resumen_material.dart';
...
class _AddMaterialState extends State<AddMaterial> {
    ...
    return SafeArea(
      child: BlocProvider(
        ...
        child: Scaffold(
          ...
          body: BlocBuilder<AddMaterialCubit, AddMaterialState>(
          ...
          children: [
            ...
            BlocBuilder<AddMaterialCubit, AddMaterialState>(
              builder: (context, state) {
                return BtnWidget(
                    action: () async {
                      final r = await _cubit.registrarVenta();
                      if (r.isEmpty) return;
                      // ignore: use_build_context_synchronously
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (_) => ResumenMaterial(data: r)));
                    },
                    txt: "Finalizar",
  ...
  Widget _clearFilter() => BlocBuilder<AddMaterialCubit, AddMaterialState>(
        builder: (context, state) {
          return Visibility(
