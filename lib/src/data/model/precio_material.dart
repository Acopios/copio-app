...
PrecioMaterial precioMaterialFromJson(String str) =>
...
class PrecioMaterial {
  ...
  factory PrecioMaterial.fromJson(Map<String, dynamic> json) => PrecioMaterial(
        ...
        precios: List<PrecioModel>.from(
            json["precios"].map((x) => PrecioModel.fromJson(x))),
      );
...
class PrecioModel {
  ...
  factory PrecioModel.fromJson(Map<String, dynamic> json) => PrecioModel(
        ...
        recolectorModel: json["recolector"] == null
            ? RecolectorModel.fromJson({})
            : RecolectorModel.fromJson(json["recolector"]),
        ...
        mayorista: json["mayorista"] == null
            ? MayoristaModel.fromJson({})
            : MayoristaModel.fromJson(json["mayorista"]),
